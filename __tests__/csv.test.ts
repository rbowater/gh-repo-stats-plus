...
describe('csv', () => {
  ...
  describe('column constants', () => {
    ...
    it('should have expected repo stats column count', () => {
      expect(REPO_STATS_COLUMNS).toHaveLength(67);
    });
